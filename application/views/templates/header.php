...
<link rel="stylesheet" href="<?php echo base_url().'styles/css/news-style.css' ?>" />
...
<script language="javascript" src="<?php echo base_url(); ?>js/jquery-ui-1.9.2.custom.js"></script>
